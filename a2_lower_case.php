...
if(isset($_SESSION['query'])){
	$query=$_GET['pid'];
	$query3=strtolower($query);
	echo "<font size='6'><center>String after lowercase conversion is&nbsp;&nbsp;&nbsp;</br></br>'<b> ".$query3." '</b></br></br>";
	if(isset($_POST['next3'])){
		$query4=$_POST['this'];
	//	echo $query;
		//$_SESSION['query']=$query;
	header("location: a3_token.php?pid=$query4");
}
}
?>
<form id="me" method="post" action="a2_lower_case.php?pid=<?php echo $query; ?>">
<input type="hidden" name="this" value="<?php echo $query; ?>"/>
<center><input type="submit" name="next3" value="Next"/>
</form>
</body>
</html>